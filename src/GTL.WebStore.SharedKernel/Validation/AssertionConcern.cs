using GTL.WebStore.SharedKernel.Events;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Text.RegularExpressions;

namespace GTL.WebStore.SharedKernel.Validation
{
    public static class AssertionConcern
    {
        ...
        /// <summary>
        /// Assert if the string value not matches with the Regex Pattern
        /// </summary>
        /// <param name="pattern">Regex Pattern</param>
        /// <param name="stringValue">String value</param>
        /// <param name="message">Message to return if Assert occurred</param>
        /// <returns>DomainNotification object</returns>
        public static DomainNotification AssertNotMatches(string pattern, string stringValue, string message)
        {
            var regex = new Regex(pattern);
        ...
        /// <summary>
        /// Assert if the validation statement or boolean value is false
        /// </summary>
        /// <param name="boolValue">Validation statement or boolean value</param>
        /// <param name="message">Message to return if Assert occurred</param>
        /// <returns>DomainNotification object</returns>
        ...
        {
            return (boolValue)
                ? new DomainNotification("AssertArgumentFalse", message)
                : null;
        }
